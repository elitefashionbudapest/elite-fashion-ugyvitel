...
<form method="POST" action="<?= base_url('/settings/permissions') ?>">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-6">
        <div>
            ...
            <p class="text-on-surface-variant text-sm">Állítsd be melyik fiók milyen menüpontokat lát és szerkeszthet.</p>
        </div>
                ...
                <table class="w-full text-sm border-collapse">
                    <thead>
                        <tr class="bg-surface-container-low">
                            ...
                            <th class="px-3 py-4 text-center text-xs font-bold text-on-surface-variant uppercase tracking-widest border-l border-surface-container" colspan="2">
                        ...
                        <tr class="bg-surface-container-low/50 border-b border-surface-container">
                            <th></th>
                            <?php foreach ($allUsers as $u): ?>
                            <th class="px-2 py-1 text-center text-[10px] text-gray-400 border-l border-surface-container">Lát</th>
                            <th class="px-2 py-1 text-center text-[10px] text-gray-400">Szerk.</th>
                            <?php endforeach; ?>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="border-t border-surface-container hover:bg-surface-container-low/30 transition-colors">
                            ...
                            ?>
                            <td class="px-2 py-3 text-center border-l border-surface-container">
                                <input type="checkbox"
